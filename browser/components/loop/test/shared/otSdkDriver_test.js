...
describe("loop.OTSdkDriver", function () {
  ...
  var fakeElement1, fakeElement2, publisherConfig;
  ...
  describe("#setupStreamElements", function() {
    it("should call initPublisher", function() {
      dispatcher.dispatch(new sharedActions.SetupStreamElements({
        getLocalElementFunc: function() {return fakeElement1;},
        getRemoteElementFunc: function() {return fakeElement2;},
        publisherConfig: publisherConfig
      }));

      sinon.assert.calledOnce(sdk.initPublisher);
      sinon.assert.calledWith(sdk.initPublisher, fakeElement1, publisherConfig);
    });
    ...
    describe("streamCreated", function() {
      ...
      it("should subscribe to the stream", function() {
        ...
        sinon.assert.calledWithExactly(session.subscribe,
          fakeStream, fakeElement2, publisherConfig);
      });
